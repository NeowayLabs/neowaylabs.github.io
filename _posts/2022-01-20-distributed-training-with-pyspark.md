...
In order to make things a bit harder, we are going to configure only 10 features as informative, flip 10% of the target values and shorten the distance between classes. Why this? Because we chose this way. You are welcome to reproduce this experiment with other combinations. Have fun!
